...
import com.example.mp3project.Adapter.SongAdapter;
import com.example.mp3project.databinding.DetailAlbumBinding;
...
public class DetailAlbum extends Activity implements View.OnClickListener, SongAdapter.ItemClickListener {
    ...
    private void initView() {
        ...
        Glide.with(this).load(R.drawable.ic_queue_music).into(binding.imvDetailA);
